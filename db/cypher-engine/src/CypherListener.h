...
public:
  ...
  virtual void enterOC_ReturnBody(CypherParser::OC_ReturnBodyContext *ctx) = 0;
  virtual void exitOC_ReturnBody(CypherParser::OC_ReturnBodyContext *ctx) = 0;

  virtual void enterOC_ReturnItems(CypherParser::OC_ReturnItemsContext *ctx) = 0;
  virtual void exitOC_ReturnItems(CypherParser::OC_ReturnItemsContext *ctx) = 0;

  virtual void enterOC_ReturnItem(CypherParser::OC_ReturnItemContext *ctx) = 0;
  virtual void exitOC_ReturnItem(CypherParser::OC_ReturnItemContext *ctx) = 0;
